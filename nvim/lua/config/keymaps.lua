...
map("n", cmd_shift_t, "<cmd>e #<cr>", { desc = "Reopen last buffer (Cmd+Shift+T)" })
map("i", cmd_shift_t, "<Esc><cmd>e #<cr>", { desc = "Reopen last buffer (Cmd+Shift+T)" })
map("v", cmd_shift_t, "<Esc><cmd>e #<cr>", { desc = "Reopen last buffer (Cmd+Shift+T)" })
